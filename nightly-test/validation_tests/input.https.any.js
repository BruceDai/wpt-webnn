...
const tests = [
  ...
  {
    testName: '[input] Throw if the number of elements is too large with dimensions [2 ** 32 - 1, 2 ** 32 - 1, 2 ** 32 - 1]',
    name: 'input',
    descriptor: {
      dataType: 'float32',
  ...
  {
    testName: '[input] Throw if the number of elements is too large with dimensions [2 ** 32, 2 ** 32, 2 ** 32]',
    name: 'input',
    descriptor: {
      dataType: 'float32',
