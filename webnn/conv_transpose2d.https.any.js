// META: title=float16 tests WebNN API convTranspose2d operation
// META: global=window
// META: variant=?cpu
// META: variant=?gpu
// META: variant=?npu
...
const convTranspose2dTests = [
  ...
  // {
  //   'name':
  //       'convTranspose2d same output size different padding (padding=1, outputPadding=0))',
  //   'graph': {
  //     'inputs': {
  //       'convTranspose2dInput': {
  ...
  //       'convTranspose2dOutput': {
  //         'data': [
  //           1, 1, 2, 2, 2, 3, 3, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5,
  //           5, 5, 6, 6, 4, 4, 5, 5, 5, 6, 6, 4, 4, 5, 5, 5, 6,
  //           6, 7, 7, 8, 8, 8, 9, 9, 7, 7, 8, 8, 8, 9, 9
  //         ],
  ...
  //       'convTranspose2dOutput': {
  //         'data': [
  //           1, 2, 2, 2, 3, 3, 3, 4, 5, 5, 5, 6, 6, 6, 4, 5, 5,
  //           5, 6, 6, 6, 4, 5, 5, 5, 6, 6, 6, 7, 8, 8, 8, 9, 9,
  //           9, 7, 8, 8, 8, 9, 9, 9, 7, 8, 8, 8, 9, 9, 9
  //         ],
  //         'descriptor': {shape: [1, 1, 7, 7], dataType: 'float32'}
  //       }
  //     }
